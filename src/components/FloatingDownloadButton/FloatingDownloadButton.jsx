...
const FloatingDownloadButton = () => {
  ...
  const downloadAPK = (filename, downloadName) => {
    ...
    link.href = `https://github.com/Rafa-Smart/smakzie-smartren-muslim-app/releases/download/v1.0.0/smakzie-muslim.apk`;
            ...
            >
              ...
              ">
                ...
                <div className="p-3 md:p-4 space-y-2 md:space-y-3">
                  ...
                  <div className="pt-1">
                    <a
                      href="https://github.com/Rafa-Smart/smakzie-smartren-muslim-app/releases/download/v1.0.0/smakzie-muslim.apk"
